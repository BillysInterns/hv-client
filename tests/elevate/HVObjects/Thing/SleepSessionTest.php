...
use elevate\HVObjects\Thing\SleepSession;

class SleepSessionTest extends BaseObjectTest
{
    public static function setUpBeforeClass()
    {
        self::$sampleXMLPath    = __DIR__ . '/../SampleXML/Thing/SleepSession.xml';
        self::$objectNamespace  = 'elevate\HVObjects\Thing\SleepSession';
        ...
        $dataXml = new SleepSessionDataXML($sleepSessionType, $common);

        self::$testObject = new SleepSession($dataXml);
