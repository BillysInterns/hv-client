...
use elevate\HVObjects\Thing\Immunization;
use elevate\HVObjects\Generic\Common;

class ImmunizationTest extends BaseObjectTest
{
	public static function setUpBeforeClass()
    {
		self::$sampleXMLPath = __DIR__ . '/../SampleXML/Thing/Immunization.xml';
        ...
        self::$testObject = new Immunization($immunizationDataXML);
