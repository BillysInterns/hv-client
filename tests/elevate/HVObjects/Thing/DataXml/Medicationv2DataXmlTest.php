...
class Medicationv2DataXmlTest extends BaseObjectTest
{

    public static function setUpBeforeClass()
    {
        self::$sampleXMLPath = __DIR__ . '/../../SampleXML/Thing/DataXml/Medicationv2.xml';
        ...
        self::$testObject = new Medicationv2DataXML($medicationType, $common);
