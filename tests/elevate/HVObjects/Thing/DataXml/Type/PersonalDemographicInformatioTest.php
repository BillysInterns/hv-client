...
class PersonalDemographicInformatioTest extends BaseObjectTest
{
    ...
    {
        self::$sampleXMLPath = __DIR__ . '/../../../SampleXML/Thing/DataXml/Type/PersonalDemographicInformation.xml';
        self::$objectNamespace = 'elevate\HVObjects\Thing\DataXML\Type\PersonalDemographicInformationType';
        ...
        self::$testObject = new PersonalDemographicInformationType(
            $name,
            $birthdate,
            $bloodtype,
            $ethnicity,
