...
class Medicationv2TypeTest extends BaseObjectTest
{

    public static function setUpBeforeClass()
    {
        self::$sampleXMLPath = __DIR__ . '/../../../SampleXML/Thing/DataXml/Type/Medicationv2.xml';
        self::$objectNamespace = 'elevate\HVObjects\Thing\DataXML\Type\Medication2Type';
        ...
        self::$testObject = new Medicationv2Type($nameOfMed, $dateDiscontinued, $dateStarted, $dose, $frequency, $genericName, $indication, $prescribed, $prescription, $route, $strength);
