...
class MedicationDataXmlTest extends BaseObjectTest
{

    public static function setUpBeforeClass()
    {
        self::$sampleXMLPath = __DIR__ . '/../../SampleXML/Thing/DataXml/Medication.xml';
        self::$objectNamespace = 'elevate\HVObjects\Thing\DataXML\MedicationDataXML';
