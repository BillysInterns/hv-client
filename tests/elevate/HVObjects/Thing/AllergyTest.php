...
use elevate\HVObjects\Thing\Allergy;
...
class AllergyTest extends BaseObjectTest
{
    public static function setUpBeforeClass()
    {
        self::$sampleXMLPath    = __DIR__ . '/../SampleXML/Thing/Allergy.xml';
        self::$objectNamespace  = 'elevate\HVObjects\Thing\Allergy';
        ...
        self::$testObject = new Allergy($dataXML);
