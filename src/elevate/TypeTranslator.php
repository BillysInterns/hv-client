...
class TypeTranslator
{
     ...
     *
     * @param $typeName string The Type Name to translate
     *
     * @return string|bool The type id for the passed type name or false if it dose not exist
     */
    ...
    /**
     * Translate the type id into a type name and optionally strip off the versioning information.
     *
     * @param      $typeID          The Type Id to translate into a type name
     * @param bool $stripCharacters If set to true, the version will be stripped off of the type name
     *
     * @return string The type name for the passed type id
     */
